...
function SpecialitySection() {
  ...
  const reveal = {
    initial: "hidden",
    whileInView: "visible",
    viewport: specialityViewport,
  };

  return (
    <section className="flex flex-col py-12.5 px-5">
      ...
      <div className="flex flex-col">
        ...
        >
          ...
          >
            ...
            web and mobile applications across the insurance, banking,
            education, and GIS sectors. Specialized in React, React Native,
            Next.js, TypeScript, and API integration, with hands-on experience
            delivering end-to-end solutions covering frontend development,
            backend services, database design, cloud infrastructure, and
            deployment.
          </motion.span>
          <motion.span variants={animation.descriptionPart} className="block">
            ...
            Prudential Indonesia and Bank Tabungan Negara (BTN). Holds a
            Master’s degree in Computer Science with a specialization in Data
            Science and research experience in NLP, Fuzzy Logic, and Explainable
            AI for healthcare.
          </motion.span>
        </motion.p>
